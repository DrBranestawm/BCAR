...
If you use FBC(formerly BCE) and want special expressions for BCAR reactions <s>I recommend to add this addon to your list. (Requiers [FBC](https://sidiousious.gitlab.io/bce/) and [BCAR](https://github.com/DrBranestawm/BCAR#))  
...
Use the command <b>/bcar expressionon</b>
