...
(async function () {
  ...
  const bcarSettingsKey = () => `bcarSettings.${Player?.AccountName}`;
    ...
    const BCAR_CHANGELOG =
          ...
          "<br>- Fix (b): Disabled the /wardrobe command due to a crash" +
          "<br>" +
          "<br>BCAR+ v0.7.5(a)" +
          "<br>- Crash on head or interactions when BCTweaks is not loaded"
...
*/
    ...
    PreferenceSubscreenList.splice(1, 0, "BCARSettings");
