...
(async function () {
  ...
  const bcarSettingsKey = () => `bcarSettings.${Player?.AccountName}`;
    const subcommands = ["arousalhelp", "arousaloff", "arousalon", "changelog", "earhelp", "earoff", "earon", "ear1", "ear2", "expressionhelp", "expressionon", "expressionoff", "male", "female", "other", "help", "load1", "load2", "profile1", "profile2", "profilehelp", "save1", "save2", "status", "tailhelp", "tailoff", "tailon", "tail1", "tail2", "winghelp", "wingoff", "wingon", "wing1", "wing2"];
  ...
  //Functions
    ...
    function ActivityBeeper(type,nya){
      ...
      ServerSend("ChatRoomChat",{Type:"Chat",Content:typeAction[type][0][nya]});
    }
...
//      }
    ...
    async function bcarSettingsLoad() {
        ...
        asleep: false,
        expressionsEnable : true,
        expressionsStatus : "Enabled",
